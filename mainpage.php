...
<html>
    ...
    <!-- Carousel -->
        ...
        <div class="carousel-item active">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQm9pr2iqJsCNug7eRIviP20GKSeQmdaK8Nig&usqp=CAU" alt="Bank" class="d-block" style="width:100%">
        ...
        <div class="carousel-item">
            <img src="https://cdn3.vectorstock.com/i/1000x1000/90/37/icons-for-the-banking-system-vector-20399037.jpg" alt="Chicago" class="d-block" style="width:100%">
            <div class="carousel-caption">
        ...
        <div class="carousel-item">
            <img src="https://www.edgeverve.com/the-edge-quarterly/wp-content/uploads/2021/04/Bank-Future-img.png" alt="New York" class="d-block" style="width:100%">
            <div class="carousel-caption">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <img src="https://hexaware.com/wp-content/uploads/2022/05/1920x1080-20.jpg" class="img-fluid" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="100">
                </div>
                <!-- Services Buttons -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="500" data-aos-offset="100">
                    <img src="https://res.cloudinary.com/g-tej-media/image/upload/v1590738359/digital-transformation-banking-pioneer.jpg" height="70%" width="90%">
                </div>
